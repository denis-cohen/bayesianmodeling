---
title: 'Lecture: Doing Bayesian data analysis with brms'
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
- understand the basic functionality of the brms package
- specify and estimate Bayesian regression models with brms
- interpret model output and posterior summaries
- carry out a basic Bayesian workflow in brms
...
*Quick guides on interpretation:*

- [Potential scale reduction factor (`Rhat`)](https://mc-stan.org/bayesplot/articles/visual-mcmc-diagnostics.html#mcmc_rhat-mcmc_rhat_hist)
- [Effective sample size (`Bulk_ESS`, `Tail_ESS`)](https://mc-stan.org/bayesplot/articles/visual-mcmc-diagnostics.html#effective-sample-size)
...
- [Potential scale reduction factor (`rhat`)](https://mc-stan.org/bayesplot/articles/visual-mcmc-diagnostics.html#mcmc_rhat-mcmc_rhat_hist)
- [Autocorrelation (`acf`)](https://mc-stan.org/bayesplot/articles/visual-mcmc-diagnostics.html#autocorrelation)
- [Trace plot (`trace`)](https://mc-stan.org/bayesplot/articles/visual-mcmc-diagnostics.html#mcmc_trace)
...
```{r algo-diag, exercise=TRUE, eval=eval_ex, exercise.lines = 3, message=TRUE, warning=TRUE}
rstan::check_hmc_diagnostics(lm_brms$fit)
```

*Quick guides on interpretation:*

- [Divergent transitions after warmup](https://mc-stan.org/learn-stan/diagnostics-warnings.html#divergent-transitions-after-warmup)
- [Maximum tree depth](https://mc-stan.org/learn-stan/diagnostics-warnings.html#maximum-treedepth)
- [BFMI low](https://mc-stan.org/learn-stan/diagnostics-warnings.html#bfmi-low)
