...
```{r data, exercise=TRUE, eval=eval_ex, echo=echo_ex}
# Define data
...
...
```{r compilation, exercise=TRUE, eval=eval_ex, echo=echo_ex, exercise.timelimit = 120}
lm_mod <- ...
...
```{r estimation, exercise=TRUE, eval=eval_ex, echo=echo_ex}
lm_est <- ...
...
```{r summary, exercise=TRUE, eval=eval_ex, echo=echo_ex}
...
```{r extraction, exercise=TRUE, eval=eval_ex, echo=echo_ex}
beta_draws <- ...
...
```{r qoi-posterior, exercise=TRUE, eval=eval_ex, echo=echo_ex}
...
...
```{r qoi-summary, exercise=TRUE, eval=eval_ex, echo=echo_ex}
pred_summary <- ...
...
```{r viz, exercise=TRUE, eval=eval_ex, echo=echo_ex, fig.align='center', fig.width = 9, fig.height=6, exercise.timelimit = 120}
