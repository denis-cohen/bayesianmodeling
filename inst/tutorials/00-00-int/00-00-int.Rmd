...
As a segue from Week 1 to Week 2, I have prepared a self-learn module that covers the following topics:

- Linear algebra and programming basics
...
*Note:* The materials currently cover Week 1 and the take-home exercise. I will notify you once I add Week 2.
...
- Likewise, you can find HTML scripts of the **lab exercises** in the folder `lab-materials`.
- If you prefer working on the exercises outside of the interactive `learnr` environment (i.e., in a regular R session), you can use the `Rmd` files supplied in the same folder.


Along with the data used in this course, these materials are available from my GitHub (see subfolders `lecture-materials`, `lab-materials`, and `data`)
