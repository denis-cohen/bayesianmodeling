---
title: 'Lecture: Going Bayesian in applied research'
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
- understand when Bayesian methods are useful in applied research
- compare common software options for Bayesian data analysis
- explain the main steps of the Bayesian workflow
- connect Bayesian modeling choices to substantive research questions
...
- a high-end platform for model development and model building for advanced users in search of custom modeling solutions ($\rightarrow$ *Week 2* -- Stan and `rstan`)
- a versatile and relatively easy-to-use toolbox for applied researchers using **R** who seek to go Bayesian using pre-implemented models and functions ($\rightarrow$ *Week 1* -- `brms`; also `rstanarm`, `rethinking`)
